...
const tagStyle = { fontFamily: FONT_SANS, fontSize: 11, padding: "4px 10px", borderRadius: 6, display: "inline-flex", alignItems: "center", gap: 6 };
    ...
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontFamily: FONT_SANS, fontSize: 11, color: completionPct === 100 ? C.green : C.textTertiary }}>{completionPct}%</span>
        </div>
      </div>
      ...
      <div style={{ ...cardStyle, background: `linear-gradient(135deg, ${C.bgAI} 0%, ${C.bgCard} 100%)`, border: `1px solid ${C.borderAI}` }}>
        ...
        {extractStatus && (
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 8, fontFamily: FONT_SANS, fontSize: 11, color: extractStatus.startsWith("Done") ? C.green : C.aiBlue }}>
              ...
              <div key={key} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => updateProfile({ branding: { ...(profile?.branding || {}), [key]: e.target.value } })}
                    placeholder="Not set"
                    style={{ ...smallInputStyle, width: 80, fontSize: 10, padding: "3px 6px", fontFamily: FONT_SANS }}
                  />
                </div>
              </div>
            );
      ...
      <div style={cardStyle}>
        <div style={cardHeaderStyle}>
          ...
          <span style={{ fontFamily: FONT_SANS, fontSize: 10, color: C.textTertiary, marginLeft: "auto" }}>{(profile?.products || []).length} products</span>
        </div>
        {(profile?.products || []).map((prod, i) => (
          <div key={i} style={{ display: "flex", gap: 6, marginBottom: 6, alignItems: "center" }}>
            ...
            <input value={prod.price || ""} onChange={e => { const prods = [...(profile.products || [])]; prods[i] = { ...prods[i], price: e.target.value }; updateProfile({ products: prods }); }} placeholder="Price" style={{ ...smallInputStyle, flex: 1, fontFamily: FONT_SANS }} />
      ...
      <div style={cardStyle}>
        <div style={cardHeaderStyle}>
          <FileText size={16} style={{ color: "#16A368" }} />
